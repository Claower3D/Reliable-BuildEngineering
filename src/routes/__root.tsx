  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Build Engineering Group & Reliable — Инженерно-строительный альянс" },
      {
        ...
        content:
          "Проектирование, строительство, инженерные изыскания и экспертиза промышленной безопасности для предприятий Республики Казахстан.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,600;9..144,800&family=Inter+Tight:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
  }),
