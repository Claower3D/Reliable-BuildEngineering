...
const clients = [
  { name: "АО «ТНК «Казхром»", work: "Ремонт АБК, дренажная система, ремонт и освидетельствование баллонов", logo: "/erg-logo.png" },
  { name: "АО «Марганец Жайрема»", work: "Ремонт здания АБК ДСК, кровли, фасадов, тепловых сетей, душевых", logo: "/erg-logo.png" },
  { name: "АО «Шубарколь Комир»", work: "Ремонт фасадов, кровли, учебных классов, конвейерных эстакад", logo: "/erg-logo.png" },
  { name: "АО «Алюминий Казахстана»", work: "Ремонт кровли ЦВТ, УСХ, АУП, ремонтных боксов и общежитий", logo: "/erg-logo.png" },
  { name: "АО «ЕЭК»", work: "Капитальный ремонт фундамента рельсового пути БУПМ", logo: "/erg-logo.png" },
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    {c.logo ? (
                      <img src={c.logo} alt="Client Logo" className="h-6 w-auto object-contain opacity-60 grayscale hover:grayscale-0 transition" />
                    ) : (
